				...
				.then((réponse) => {
					...
					réponse.data.forEach((arr) => {
						...
						if (newCharacter.gender === 'Male' ||
								...
								newCharacter.gender === 'unknown') newCharacter.points += 10;
						...
						//species
						if (newCharacter.species === 'Human' ||
								newCharacter.species === 'Humanoid' ||
								newCharacter.species === 'Animal' ||
								newCharacter.species === 'Poopybutthole') newCharacter.points += 20;
						if (newCharacter.species === 'Alien' ||
								newCharacter.species === 'Robot' ||
								newCharacter.species === 'Mytholog') newCharacter.points += 25;
						if (newCharacter.species === 'Cronenberg') newCharacter.points += 18;
						//origin
						if (newCharacter.origin === 'unknown' ||
							newCharacter.origin === 'Earth (C-137)' ||
							newCharacter.origin === 'Earth (Replacement Dimension)' ||
							newCharacter.origin === 'Earth (C-500A)' ||
							newCharacter.origin === 'Earth (D716)' ||
							newCharacter.origin === 'Earth (Giant Telepathic Spiders Dimension)' ||
							newCharacter.origin === 'Resort Planet' ||
							newCharacter.origin === "Snuffles' Dream" ||
							newCharacter.origin === "Earth (J19ζ7)") newCharacter.points += 20;
						if (newCharacter.origin === 'Hamster in Butt World' ||
							newCharacter.origin === 'Árboles Mentirosos' ||
							newCharacter.origin === 'Earth (D716-B)' ||
							newCharacter.origin === 'Earth (J-22)' ||
							newCharacter.origin === 'Trunk World') newCharacter.points += 19;
						if (newCharacter.origin === 'Earth (D716-C)' ||
							newCharacter.origin === 'Hideout Planet' ||
							newCharacter.origin === 'Glaagablaaga' ||
							newCharacter.origin === 'Post-Apocalyptic Earth' ||
							newCharacter.origin === "Zeep Xanflorp's Miniverse") newCharacter.points += 18;
						if (newCharacter.origin === 'Pluto' ||
							newCharacter.origin === 'Venzenulon 7' ||
							newCharacter.origin === 'Abadango' ||
							newCharacter.origin === 'Anatomy Park') newCharacter.points += 15;
						if (newCharacter.origin === 'Gazorpazorp' ||
							newCharacter.origin === 'Interdimensional Cable' ||
							newCharacter.origin === 'Purge Planet') newCharacter.points += 30;
						if (newCharacter.origin === 'Bird World') newCharacter.points += 50;
						if (newCharacter.origin === 'Alphabetrium' ||
							newCharacter.origin === "Mr. Goldenfold's dream") newCharacter.points += 100;
